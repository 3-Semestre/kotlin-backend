...
class UsuarioService (
    ...
    fun buscaUsuariosNovos(tipoAcesso: NivelAcessoNome, dataCorte: LocalDate): List<UsuarioResponse>{
        val usuarios = usuarioRepository.findByNivelAcessoNomeAndDataCadastroDate(tipoAcesso, dataCorte)
        validarLista(usuarios)
        val usuariosResponse = retornaListaUsuario(usuarios)
        return usuariosResponse
    }
